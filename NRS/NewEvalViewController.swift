...
class NewEvalViewController: UIViewController, UIPickerViewDataSource ,UIPickerViewDelegate
{
    ...
    func createNewEvalScoreSession()
    {
        ...
        let scoreSession = Score(/*scoreIdInit: noScore, */sitInit: noScore, reverseSitUpInit: noScore, sitUpInit: noScore,trunkExtensionInSittingInit: noScore, overheadPressRightInit: noScore, overheadPressLeftInit: noScore, forwardReachAndGraspRightInit: noScore, forwardReachAndGraspLeftInit: noScore, doorPullAndOpenRightInit: noScore, doorPullAndOpenLeftInit: noScore, canOpenAndManipulationRightInit: noScore, canOpenAndManipulationLeftInit: noScore, sitToStandInit: noScore, standInit: noScore,walkingInit: noScore, standAdaptabilityInit: noScore, stepRetrainingInit: noScore, stepAdaptabilityInit: noScore, versionInit: self.selectedVersionAfterDoneButtonClick)
